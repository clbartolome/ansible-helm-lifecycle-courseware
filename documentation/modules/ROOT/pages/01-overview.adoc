...
You may login using your credentials and go to the *Templates* section. You should see the following list of job and workflow templates ready to use:

- [JT] Create Test Namespace
- [JT] Delete Test Namespace		
- [JT] Helm Package Nexus		
- [JT] Install Test Scenario		
- [JT] Notify New Release		
- [JT] Uninstall Test Scenario		
- [JT] Validate Test Scenario		
- [WF] Base Chart Pipeline

image::1-overview-aap.png[]
