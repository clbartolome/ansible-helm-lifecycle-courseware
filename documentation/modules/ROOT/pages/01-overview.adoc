...
As a laboratory student, you have an already created namespace named *<student>-demo-app* that contains an application used for testing the *base-chart*. The application looks like this:

image::1-overview-demoapp.png[]

TIP: To review your *demo-app* login into OpenShift, go to *topology*, select *<student>-demo-app* namespace and click the *Open Url* button.
