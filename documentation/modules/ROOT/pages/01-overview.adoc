...
NOTE: During the laboratory you will have to make changes in the playbooks that make up the Workflow *[WF] Base Chart Pipeline*. You can find all these playbooks in the *helm-ansible-pipeline* in Gitea.
